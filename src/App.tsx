...
const HOME_CONCEPT_ROUTES: Record<HomeConceptKey, { path: string; img: string }> = {
  ...
  facilities: {
    ...
    img: '/facilities-hero-event-lighting.png',
  },
};
    ...
    <footer className="site-footer-silk border-t border-brand-800/90 bg-brand-900 pt-4 text-brand-100">
      <div className="site-container pb-2 pt-1 md:pb-[8px]">
        <div className="grid grid-cols-1 items-start gap-10 lg:grid-cols-[1fr_auto_1fr] lg:gap-x-12">
          ...
          >
            <a
              href="https://www.instagram.com/ronningenselskapslokale/"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://www.facebook.com/ronningenselskapslokale"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <span
              className="flex h-9 w-9 shrink-0 cursor-default items-center justify-center rounded-sm text-brand-500/35 select-none"
              aria-label={t('footer.tiktokUnavailableAria')}
            >
              <svg
                viewBox="0 0 24 24"
                className="h-5 w-5"
