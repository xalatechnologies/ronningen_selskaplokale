    ...
    translation: {
      ...
      weddingsPage: {
        ...
        packagesSection: {
          ...
          note: 'We offer lower prices for smaller events. Contact us for more information!',
          trust: {
            predictable: {
              title: 'Safe & predictable',
              body: 'Clear packages and no hidden costs.',
            },
            flexible: {
              title: 'Flexible',
              body: 'Adapted to your needs and wishes.',
            },
            memorable: {
              title: 'A day to remember',
              body: 'We help create the right setting for your day.',
            },
            hosts: {
              title: 'Experienced hosts',
              body: 'Our team is with you all the way.',
            },
          },
          items: {
            basic: {
              name: 'Basic',
              price: 'NOK 43,000',
              desc: 'A complete package for a successful day.',
              f1: 'Venue with tables and chairs',
              f2: 'Fully equipped kitchen',
              f3: 'Technical equipment (sound & lighting)',
              f4: 'Stage & projector',
              f5: 'Final cleaning',
              f6: '1 staff member',
            },
            plus: {
              name: 'Plus',
              price: 'NOK 55,000',
              desc: 'Our most popular package — we take care of the practical details.',
              f1: 'Everything in Basic',
              f2: 'Table setup and teardown',
              f3: 'Tablecloths & chair covers',
              f4: '2 staff members',
            },
            premium: {
              name: 'Premium',
              price: 'Price on request',
              desc: 'Full package — we tailor the experience to your wishes.',
              f1: 'Everything in Plus',
              f2: 'Decor and styling',
              f3: 'Catering & servers',
              f4: 'Photography & video',
            },
          },
        },
        gallerySection: {
    ...
    translation: {
      ...
      weddingsPage: {
        ...
        packagesSection: {
          ...
          note: 'Vi tilbyr lavere priser for mindre arrangementer. Ta kontakt for mer info!',
          trust: {
            predictable: {
              title: 'Trygt & forutsigbart',
              body: 'Tydelige pakker og ingen skjulte kostnader.',
            },
            flexible: {
              title: 'Fleksibelt',
              body: 'Tilpasset deres behov og ønsker.',
            },
            memorable: {
              title: 'En dag å huske',
              body: 'Vi legger til rette for at deres dag blir helt spesiell.',
            },
            hosts: {
              title: 'Erfarne verter',
              body: 'Vårt vertskap er med dere hele veien.',
            },
          },
          items: {
            basic: {
              name: 'Basis',
              price: 'kr 43 000',
              desc: 'En komplett pakke for en vellykket dag.',
              f1: 'Lokale med bord og stoler',
              f2: 'Fullt utstyrt kjøkken',
              f3: 'Teknisk utstyr (lyd & lys)',
              f4: 'Scene & projektor',
              f5: 'Sluttrengjøring',
              f6: '1 personell',
            },
            plus: {
              name: 'Plus',
              price: 'kr 55 000',
              desc: 'Vår mest populære pakke — vi tar oss av det praktiske.',
              f1: 'Alt i Basis',
              f2: 'Oppdekking og nedrigg',
              f3: 'Bordduk & stoltrekk',
              f4: '2 personell',
            },
            premium: {
              name: 'Premium',
              price: 'Pris etter avtale',
              desc: 'Full pakke — vi skreddersyr opplevelsen etter deres ønsker.',
              f1: 'Alt i Plus',
              f2: 'Dekor og styling',
              f3: 'Catering & servitører',
              f4: 'Fotografi & video',
            },
          },
        },
